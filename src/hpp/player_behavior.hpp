...
auto reached_destination(glm::vec2 const velocity, glm::vec2 const position, glm::vec2 const destination) -> bool;
...
void set_velocity(glm::vec2 destination, crow::entities& entities,
