...
namespace end
{
	...
	{
	public:
		// TODO: This constructor is the only function for you to implement in this file. ?!?! um what can I do with root?
		bvh_node_t(bvh_node_t* root, uint32_t left_index, uint32_t right_index) : _left { left_index }, _right{ right_index } 
		{
			//seriously what am I doing with root here, can't really properly traverse into it tight now
		}

		//leaf
		bvh_node_t(const aabb_t& bounds, uint32_t id) : _aabb{ bounds }, _id{ id }, _left{ 0 } {}
