...
//  game_state.entities.allocate(3);
//
//  // TODO: move this to new game
//  for (size_t i = 0; i < game_state.entities.desc_layouts.size(); i++) {
//    crow::set_desc_layouts(game_state.entities.desc_layouts[i], &app);
//    crow::create_desc_sets(game_state.entities.desc_layouts[i],
//                           game_state.entities.desc_sets_list[i],
//                           descriptor_pool);
//    crow::update_desc_sets(game_state.entities.desc_sets_list[i], &app,
...
//        crow::shader_module{
//            .file_name = crow::get_exe_path() +
//            "../../res/spv/simple.vert.spv", .flags =
//            VK_SHADER_STAGE_VERTEX_BIT,
//        },
//        crow::shader_module{
//            .file_name = crow::get_exe_path() +
//            "../../res/spv/simple.frag.spv", .flags =
...
//        crow::create_descriptor_layout(app,
//        crow::simple_render_pass_bindings);
//    // Material buffers:
...
//        app,
//        {
//            crow::descriptor_binding{.type =
//            VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER,
//                                     .stage_flags =
//                                     VK_SHADER_STAGE_VERTEX_BIT, .binding_slot
//                                     = 0, .descriptors_count = 1},
//        });
//
...
//    environment_descriptor_layouts[1]->destroy();
//    environment_descriptor_layouts[2]->destroy();
//    environment_descriptor_layouts[3]->destroy();
//    for (size_t i = 0; i < game_state.entities.desc_layouts.size(); i++) {
//      for (size_t j = 0; j < 4; j++) {
//        game_state.entities.desc_layouts[i][j]->destroy();
//      }
//      // game_state.entities.desc_layouts[i][3]->destroy();
//    }
...
//                  ->room_mesh);  // function parameter could be changed
//                  perhaps
...
//        // game_state.minimap.active_room2->floor_mesh->bind_draw(cmd_buf);
//      }
...
//          cmd_buf, VK_PIPELINE_BIND_POINT_GRAPHICS,
//          environment_pipeline_layout->get(), 0, 4,
//          game_state.entities.desc_sets_list[crow::entity::WORKER].data(), 0,
//          nullptr);
...
//          cmd_buf, VK_PIPELINE_BIND_POINT_GRAPHICS,
//          environment_pipeline_layout->get(), 0, 4,
//          game_state.entities.desc_sets_list[crow::entity::SPHYNX].data(), 0,
//          nullptr);
//      game_state.entities.meshes[crow::entity::SPHYNX]->bind_draw(cmd_buf);*/
//
//      for (size_t i = 0; i < game_state.entities.meshes.size(); i++) {
//        app.device->call().vkCmdBindDescriptorSets(
//            cmd_buf, VK_PIPELINE_BIND_POINT_GRAPHICS,
//            environment_pipeline_layout->get(), 0, 4,
//            game_state.entities.desc_sets_list[i].data(), 0, nullptr);
//        game_state.entities.meshes[i]->bind_draw(cmd_buf);
//      }
//
...
//    game_state.enemy_manager.clean_tree();
