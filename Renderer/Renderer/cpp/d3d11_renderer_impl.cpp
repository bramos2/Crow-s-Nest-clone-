	...
	{
		{
			...
			LoadAnimData("../Renderer/Assets/Run.anim", animationClip);
			LoadBinData("../Renderer/Assets/Run.bin", meshInds, meshVerts);
			LoadMatData("../Renderer/Assets/Run.mat", filePaths, materials);
